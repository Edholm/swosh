...
class SecurityConfig {
  ...
  fun securityWebFilterChain(http: ServerHttpSecurity): SecurityWebFilterChain {
    return http.authorizeExchange()
      ...
      .contentSecurityPolicy("default-src 'self'; script-src https://use.fontawesome.com:443 https://code.jquery.com:443 'unsafe-inline' 'self'; style-src https://maxcdn.bootstrapcdn.com:443 'unsafe-inline'; img-src 'self' data:; object-src 'none'")
      .and().and()
      .httpBasic()
      .and()
      .formLogin()
